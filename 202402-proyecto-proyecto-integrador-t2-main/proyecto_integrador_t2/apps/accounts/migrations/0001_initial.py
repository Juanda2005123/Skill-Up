    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(default='default@example.com', max_length=200)),
                ('profile_pic', models.ImageField(blank=True, default='default.png', null=True, upload_to='')),
                ('experience_level', models.CharField(choices=[('Junior', 'Junior'), ('Semi-Senior', 'Semi-Senior'), ('Senior', 'Senior')], default='Junior', max_length=20)),
                ...
                ('skillExpertises', models.ManyToManyField(to='accounts.freelancerskillexpertise')),
            ],
        ),
        migrations.CreateModel(
            name='Experience',
            fields=[
                ...
                ('freelancer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='experiences', to='accounts.freelancer')),
            ],
        ),
        migrations.CreateModel(
            name='Portfolio',
            fields=[
                ...
                ('freelancer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='portfolios', to='accounts.freelancer')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
            fields=[
                ...
                ('freelancer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='accounts.freelancer')),
            ],
        ),
    ]
